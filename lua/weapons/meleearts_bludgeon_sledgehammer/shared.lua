...
SWEP.WepName="meleearts_bludgeon_sledgehammer"
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 28
SWEP.ThrowModel = "models/models/danguyen/w_me_sledge.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/models/danguyen/w_me_sledge.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.619, -0.219, -7.676), angle = Angle(-1.17, 12.857, 1.169), size = Vector(1.014, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/models/danguyen/w_me_sledge.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.236, 1, -2.597), angle = Angle(-180, 0, 0), size = Vector(1.014, 1.014, 1.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}