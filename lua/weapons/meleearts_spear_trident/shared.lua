...
SWEP.WepName="meleearts_spear_trident"
...
SWEP.Charge2 = 0
SWEP.ChargeSpeed2 = 0.7
SWEP.DmgMin2 = 9
SWEP.DmgMax2 = 35
SWEP.ThrowModel = "models/models/danguyen/channeler's_trident.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 0.8
...
SWEP.VElements = {
	["spear"] = { type = "Model", model = "models/models/danguyen/channeler's_trident.mdl", bone = "v_me_sledge", rel = "", pos = Vector(0.518, 0, -9.87), angle = Angle(0, -68.961, -87.663), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["harpoon"] = { type = "Model", model = "models/models/danguyen/channeler's_trident.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(-160.131, 80.649, -12.858), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}