...
SWEP.WepName="meleearts_staff_bamboo"
...
SWEP.ThrowMaterial = "models/props_c17/awning001b"
SWEP.ThrowScale = 1
...
SWEP.Impact1Sound="physics/metal/paintcan_impact_hard2.wav"
SWEP.Impact2Sound="physics/metal/paintcan_impact_hard3.wav"
...
function SWEP:AtkExtra()
	self.Owner:EmitSound("physics/metal/paintcan_impact_hard3.wav")
end


SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/props_c17/signpole001.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.8, -2.741, -24), angle = Angle(6.164, 94.931, -2), size = Vector(0.661, 0.661, 0.479), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_c17/awning001b", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana1"] = { type = "Model", model = "models/props_c17/signpole001.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.74, 1.644, -30.137), angle = Angle(-180, 0, -180), size = Vector(0.661, 0.661, 0.479), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_c17/awning001b", skin = 0, bodygroup = {} }
}
