...
SWEP.WepName="meleearts_spear_spartan"
...
SWEP.DmgMin2 = 10
SWEP.DmgMax2 = 32
SWEP.ThrowModel = "models/models/danguyen/spartan_spear.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["spear"] = { type = "Model", model = "models/models/danguyen/spartan_spear.mdl", bone = "v_me_sledge", rel = "", pos = Vector(0, 0, -41.04), angle = Angle(0, 0, 0), size = Vector(1.014, 1.014, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["spear"] = { type = "Model", model = "models/models/danguyen/spartan_spear.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-29.611, 1.557, 5.714), angle = Angle(-101.689, 0, 0), size = Vector(1.08, 1.08, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}